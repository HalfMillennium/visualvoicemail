...
public class GsmAlphabet {
    ...
    private static void enableCountrySpecificEncodings() {
        ...
        sEnabledSingleShiftTables = r.getIntArray(au.com.wallaceit.voicemail.R.array.config_sms_enabled_single_shift_tables);
        sEnabledLockingShiftTables = r.getIntArray(au.com.wallaceit.voicemail.R.array.config_sms_enabled_locking_shift_tables);
