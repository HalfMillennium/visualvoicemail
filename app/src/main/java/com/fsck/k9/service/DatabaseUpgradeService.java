...
public class DatabaseUpgradeService extends Service {
    ...
    public final int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (success) {
            ...
            if (VisualVoicemail.DEBUG) {
                Log.i(VisualVoicemail.LOG_TAG, "DatabaseUpgradeService started");
            }
    ...
    private void stopService() {
        ...
        if (VisualVoicemail.DEBUG) {
            Log.i(VisualVoicemail.LOG_TAG, "DatabaseUpgradeService stopped");
        }
    ...
    private void upgradeDatabases() {
        ...
        for (Account account : accounts) {
            ...
            try {
                ...
                Log.e(VisualVoicemail.LOG_TAG, "Database unavailable");
            } catch (Exception e) {
                Log.e(VisualVoicemail.LOG_TAG, "Error while upgrading database", e);
            }

            mProgress++;
        }

        VisualVoicemail.setDatabasesUpToDate(true);
