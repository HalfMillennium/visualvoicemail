...
public class MessageWebView extends RigidWebView {
    ...
    public void configure() {
        ...
        if (VisualVoicemail.autofitWidth()) {
        ...
        webSettings.setTextZoom(VisualVoicemail.getFontSizes().getMessageViewContentAsPercent());
    ...
    public void emulateShiftHeld() {
        try {
            ...
            Log.e(VisualVoicemail.LOG_TAG, "Exception in emulateShiftHeld()", e);
        }
    }
