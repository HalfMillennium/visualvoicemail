...
public class AudioPlayerDialog extends AlertDialog implements AlertDialog.OnShowListener, AlertDialog.OnCancelListener {

    protected AudioPlayerDialog(Context context) {
        super(context);
    }
