package au.com.wallaceit.voicemail.cache;
            ...
            if (file.lastModified() < cutOffTime) {
                if (file.delete()) {
                    if (VisualVoicemail.DEBUG) {
                        Log.d(VisualVoicemail.LOG_TAG, "Deleted from temporary attachment store: " + file.getName());
                    }
                } else {
                    Log.w(VisualVoicemail.LOG_TAG, "Couldn't delete from temporary attachment store: " + file.getName());
                }
            }
        }
    }
