...
public class ClientCertificateSpinner extends LinearLayout {
    ...
    public ClientCertificateSpinner(Context context, AttributeSet attrs) {
        ...
        if (context instanceof Activity) {
            ...
            Log.e(VisualVoicemail.LOG_TAG, "ClientCertificateSpinner init failed! Please inflate with Activity!");
        }
        ...
        KeyChain.choosePrivateKeyAlias(mActivity, new KeyChainAliasCallback() {
            ...
            public void alias(String alias) {
                if (VisualVoicemail.DEBUG)
                    Log.d(VisualVoicemail.LOG_TAG, "User has selected client certificate alias: " + alias);
