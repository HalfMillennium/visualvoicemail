...
public class Storage implements SharedPreferences {
    ...
    private SQLiteDatabase openDB() {
        ...
        if (mDb.getVersion() == 1) {
            Log.i(VisualVoicemail.LOG_TAG, "Updating preferences to urlencoded username/password");
            ...
            if (accountUuids != null && accountUuids.length() != 0) {
                ...
                for (String uuid : uuids) {
                    try {
                        ...
                        Log.e(VisualVoicemail.LOG_TAG, "ooops", e);
                    }
                }
            }
        ...
        if (mDb.getVersion() != DB_VERSION) {
            Log.i(VisualVoicemail.LOG_TAG, "Creating Storage database");
    ...
    public static com.fsck.k9.preferences.Storage getStorage(Context context) {
        ...
        if (tmpStorage != null) {
            ...
            if (oldStorage != null) {
                ...
                if (VisualVoicemail.DEBUG) {
                    Log.d(VisualVoicemail.LOG_TAG, "Returning the Storage we created");
                }
                return tmpStorage;
            }
        }
    ...
    private void loadValues() {
        ...
        Log.i(VisualVoicemail.LOG_TAG, "Loading preferences from DB into Storage");
        Cursor cursor = null;
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                if (VisualVoicemail.DEBUG) {
                    Log.d(VisualVoicemail.LOG_TAG, "Loading key '" + key + "', value = '" + value + "'");
                }
            ...
            Log.i(VisualVoicemail.LOG_TAG, "Preferences load took " + (endTime - startTime) + "ms");
        }
    }
    ...
    public float getFloat(String key, float defValue) {
        ...
        try {
            ...
            Log.e(VisualVoicemail.LOG_TAG, "Could not parse float", nfe);
            return defValue;
        }
    }
    ...
    public int getInt(String key, int defValue) {
        ...
        try {
            ...
            Log.e(VisualVoicemail.LOG_TAG, "Could not parse int", nfe);
            return defValue;
        }
    }
    ...
    public long getLong(String key, long defValue) {
        ...
        try {
            ...
            Log.e(VisualVoicemail.LOG_TAG, "Could not parse long", nfe);
            return defValue;
        }
    }
    ...
    private void writeValue(SQLiteDatabase mDb, String key, String value) {
        ...
        if (result == -1) {
            Log.e(VisualVoicemail.LOG_TAG, "Error writing key '" + key + "', value = '" + value + "'");
        }
    }
