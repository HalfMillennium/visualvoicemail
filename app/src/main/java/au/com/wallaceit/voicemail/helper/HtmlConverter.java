...
public class HtmlConverter {
    ...
    */
     ...
     */
    private static class HtmlToTextTagHandler implements TagHandler {
        ...
        /**
         * Fetch the matching opening Annotation object and verify that it's the one added by VisualVoicemail.
    ...
    public static String cssStylePre() {
        final String font = VisualVoicemail.messageViewFixedWidthFont()
                ? "monospace"
                : "sans-serif";
