...
public class AttachmentController {
    ...
    public void saveAttachment() {
        saveAttachmentTo(VisualVoicemail.getAttachmentDefaultPath());
    }
        ...
        if (resolvedIntentInfo.hasResolvedActivities() && resolvedIntentInfo.containsFileUri()) {
            try {
                ...
                if (VisualVoicemail.DEBUG) {
                    Log.e(VisualVoicemail.LOG_TAG, "Error while saving attachment to use file:// URI with ACTION_VIEW Intent", e);
                }
    ...
    private class ViewAttachmentAsyncTask extends AsyncTask<Void, Void, Intent> {
        ...
        private void viewAttachment(Intent intent) {
            try {
                ...
                Log.e(VisualVoicemail.LOG_TAG, "Could not display attachment of type " + attachment.mimeType, e);
    ...
    private class SaveAttachmentAsyncTask extends AsyncTask<File, Void, File> {
        ...
        protected File doInBackground(File... params) {
            try {
                ...
                if (VisualVoicemail.DEBUG) {
                    Log.e(VisualVoicemail.LOG_TAG, "Error saving attachment", e);
                }
                return null;
            }
        }
