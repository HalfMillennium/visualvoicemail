        ...
        try
        {
            ...
            if (os != null) {
                try {
                    ...
                    Log.w(VisualVoicemail.LOG_TAG, "Couldn't close exported settings file: " + filename);
                }
            }
        }
    }
        ...
        for (Entry<String, TreeMap<Integer, SettingsDescription>> versionedSetting :
            ...
            if (valueString != null) {
                try {
                    ...
                    Log.w(VisualVoicemail.LOG_TAG, "Global setting \"" + key  + "\" has invalid value \"" +
                            valueString + "\" in preference storage. This shouldn't happen!");
                }
            } else {
                if (VisualVoicemail.DEBUG) {
                    Log.d(VisualVoicemail.LOG_TAG, "Couldn't find key \"" + key + "\" in preference storage." +
                            "Using default value.");
                }
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        Log.w(VisualVoicemail.LOG_TAG, "Account setting \"" + keyPart  + "\" (" +
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        Log.w(VisualVoicemail.LOG_TAG, "Folder setting \"" + folderKey +
                                "\" has invalid value \"" + valueString +
                                "\" in preference storage. This shouldn't happen!");
                    }
                }
