...
public class AttachmentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        try {
            ...
            Log.e(VisualVoicemail.LOG_TAG, "Unable to retrieve attachment info from local store for ID: " + id, e);
            return null;
        }

        if (attachmentInfo == null) {
            if (VisualVoicemail.DEBUG) {
                Log.d(VisualVoicemail.LOG_TAG, "No attachment info for ID: " + id);
            }
            return null;
        }
    ...
    private String getType(String accountUuid, String id, String mimeType) {
        ...
        try {
            ...
            Log.e(VisualVoicemail.LOG_TAG, "Unable to retrieve LocalStore for " + account, e);
    ...
    private ParcelFileDescriptor openAttachment(String accountUuid, String attachmentId) {
        try {
            ...
            Log.e(VisualVoicemail.LOG_TAG, "Error getting InputStream for attachment", e);
            return null;
        } catch (IOException e) {
            Log.e(VisualVoicemail.LOG_TAG, "Error creating ParcelFileDescriptor", e);
            return null;
        }
    }
