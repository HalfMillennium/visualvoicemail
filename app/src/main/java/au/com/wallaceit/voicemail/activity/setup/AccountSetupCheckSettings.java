...
public class AccountSetupCheckSettings extends K9Activity implements OnClickListener,
    ...
    private void handleCertificateValidationException(CertificateValidationException cve) {
        Log.e(VisualVoicemail.LOG_TAG, "Error while testing settings", cve);
        ...
        mHandler.post(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Log.e(VisualVoicemail.LOG_TAG, "Error while initializing MessageDigest", e);
                }
                ...
                for (int i = 0; i < chain.length; i++) {
                    ...
                    try {
                        ...
                        if (subjectAlternativeNames != null) {
                            ...
                            for (List<?> subjectAlternativeName : subjectAlternativeNames) {
                                ...
                                case 0:
                                    Log.w(VisualVoicemail.LOG_TAG, "SubjectAltName of type OtherName not supported.");
                                    continue;
                                case 1: // RFC822Name
                                    name = (String)value;
                                    break;
                                case 2:  // DNSName
                                    ...
                                    break;
                                case 3:
                                    Log.w(VisualVoicemail.LOG_TAG, "unsupported SubjectAltName of type x400Address");
                                    continue;
                                case 4:
                                    Log.w(VisualVoicemail.LOG_TAG, "unsupported SubjectAltName of type directoryName");
                                    continue;
                                case 5:
                                    Log.w(VisualVoicemail.LOG_TAG, "unsupported SubjectAltName of type ediPartyName");
                                    continue;
                                case 6:  // Uri
                                    name = (String)value;
                                    break;
                                case 7: // ip-address
                                    ...
                                    break;
                                default:
                                    Log.w(VisualVoicemail.LOG_TAG, "unsupported SubjectAltName of unknown type");
                                    continue;
                                }
                        ...
                        Log.w(VisualVoicemail.LOG_TAG, "cannot display SubjectAltNames in dialog", e1);
                    }
                    ...
                    if (sha1 != null) {
                        ...
                        try {
                            ...
                            Log.e(VisualVoicemail.LOG_TAG, "Error while encoding certificate", e);
                        }
                    }
                }
    ...
    private class CheckAccountTask extends AsyncTask<CheckDirection, Integer, Void> {
        ...
        protected Void doInBackground(CheckDirection... params) {
            ...
            try {
                ...
                Log.e(VisualVoicemail.LOG_TAG, "Error while testing settings", afe);
                showErrorDialog(
                ...
                Log.e(VisualVoicemail.LOG_TAG, "Error while testing settings", t);
                showErrorDialog(
                        R.string.account_setup_failed_dlg_server_message_fmt,
