...
public class DateFormatter
{
	...
	// unusable constructor - this is a static class
    private DateFormatter() { }

    public static String getSampleDate(Context context, String formatString)
    {
        java.text.DateFormat formatter = DateFormatter.getDateFormat(context, formatString);
    ...
    public static String getFormat(Context context)
    {
        if (sChosenFormat == null)
        {
            ...
            {
                Log.e(VisualVoicemail.LOG_TAG, "Couldn't load date format from preferences; using default.", e);
    ...
    {
        String formatString = DateFormatter.getFormat(context);
        return DateFormatter.getDateFormat(context, formatString);
    }
}
