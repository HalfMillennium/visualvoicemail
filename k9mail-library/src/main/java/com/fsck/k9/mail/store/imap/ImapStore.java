...
public class ImapStore extends RemoteStore {
    ...
    private boolean requiresCellular;
    ...
    public ImapStore(StoreConfig storeConfig, TrustedSocketFactory trustedSocketFactory,
        ...
        requiresCellular = storeConfig.getRequiresCellular();
    ...
    ImapConnection createImapConnection() {
        return new ImapConnection(new StoreImapSettings(), mTrustedSocketFactory, connectivityManager, requiresCellular);
    }
