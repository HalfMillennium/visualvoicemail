...
public class AccountSetupOptions extends VisualVoicemailActivity implements OnClickListener {
    private static final String EXTRA_ACCOUNT = "account";

// CSM    private static final String EXTRA_MAKE_DEFAULT = "makeDefault";
    ...
    private void onDone() {
// CSM        mAccount.setDescription(mAccount.getEmail());
