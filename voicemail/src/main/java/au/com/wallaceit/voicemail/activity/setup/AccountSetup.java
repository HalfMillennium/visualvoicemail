...
import cc.martin.vv.helper.Utility;
...
public class AccountSetup extends VisualVoicemailActivity
...
// CSM     private final static String STATE_KEY_PROVIDER	= "cc.martin.vv.AccountSetupBasics.provider";
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        ArrayAdapter<Provider> providerAdaptor = new ArrayAdapter<Provider>(this, android.R.layout.simple_spinner_item, Provider.getProviderList() );
